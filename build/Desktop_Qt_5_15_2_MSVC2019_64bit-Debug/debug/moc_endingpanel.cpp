...
QT_MOC_LITERAL(1, 12, 11), // "contiueGame"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "EndingPanel\0contiueGame\0"
};
...
void EndingPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EndingPanel::contiueGame)) {
                *result = 0;
                return;
            }
        }
