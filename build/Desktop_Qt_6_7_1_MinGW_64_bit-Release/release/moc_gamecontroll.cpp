...
struct qt_meta_stringdata_CLASSGameControllENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSGameControllENDCLASS = QtMocHelpers::stringData(
    "GameControll",
    "playerStatusChanged",
    "",
    "Player*",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSGameControllENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject GameControll::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CLASSGameControllENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSGameControllENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGameControllENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<GameControll, std::true_type>,
...
void GameControll::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &GameControll::playerStatusChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &GameControll::notifyGrabLordBet; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &GameControll::gameStatusChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &GameControll::notifyPlayHand; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (GameControll::*)(Player * , Cards & );
            if (_t _q_method = &GameControll::pendingInfo; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
...
void *GameControll::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSGameControllENDCLASS.stringdata0))
