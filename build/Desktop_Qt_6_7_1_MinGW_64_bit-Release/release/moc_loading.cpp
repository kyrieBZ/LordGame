...
struct qt_meta_stringdata_CLASSLoadingENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSLoadingENDCLASS = QtMocHelpers::stringData(
    "Loading"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLoadingENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Loading::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSLoadingENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSLoadingENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLoadingENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Loading::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSLoadingENDCLASS.stringdata0))
