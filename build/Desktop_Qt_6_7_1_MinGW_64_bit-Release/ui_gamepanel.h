...
public:
    ...
    void setupUi(QMainWindow *GamePanel)
    {
        ...
        horizontalSpacer = new QSpacerItem(566, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        menubar->setGeometry(QRect(0, 0, 612, 19));
