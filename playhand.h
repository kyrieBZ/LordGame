...
private:
    //1.对扑克牌进行分类 1张的，2张的，3张的，4张的一共有多少种
...
private:
    ...
    int m_extra;//牌的附加信息
    QVector<Card::CardPoint> m_oneCard;//单牌
    QVector<Card::CardPoint> m_twoCard;//对
    QVector<Card::CardPoint> m_threeCard;//三个
    QVector<Card::CardPoint> m_fourCard;//炸弹
};
