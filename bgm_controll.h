#ifndef BGM_CONTROLL_H
#define BGM_CONTROLL_H
...
class BGM_Controll : public QObject
{
    Q_OBJECT
public:
    enum RoleSex{Man,Woman};
    enum CardType //该枚举索引以及值与json配置文件中的音乐路径一一对应
    {
        // 单张牌
        Three,
        Foue,
    ...
    explicit BGM_Controll(QObject *parent = nullptr);
